...
sets custom fan speed to 100% and engages fixed fan mode (WMI max duty
`0xE5` + fixed-speed flag). Disabling restores the fan mode and custom
speed that were active before turbo was enabled.
0 = off, 1 = on.
